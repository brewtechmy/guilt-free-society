    ...
    <footer class="bg-black text-white">
        <div class="max-w-screen-xl justify-around mx-auto py-4 gap-y-2 flex flex-col md:flex-row">
            <div class="flex flex-col lg:flex-row gap-x-4 gap-y-2">
                <a href="tel:+1234567890" class="flex flex-row self-center items-center gap-2"> <!-- Add phone number -->
                ...
                <a href="mailto:info@guiltfreesociety.com" class="flex flex-row self-center items-center gap-2"> <!-- Add email -->
