    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ingredients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('protein') ? 'is-invalid' : '' }}" type="number" name="protein" id="protein" value="{{ old('protein', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carbohydrate') ? 'is-invalid' : '' }}" type="number" name="carbohydrate" id="carbohydrate" value="{{ old('carbohydrate', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fat') ? 'is-invalid' : '' }}" type="number" name="fat" id="fat" value="{{ old('fat', '') }}" step="0.01" required>
                @if($errors->has('fat'))
            ...
            <div class="form-group">
                <label class="required" for="photo">{{ trans('cruds.ingredient.fields.photo') }}</label>
