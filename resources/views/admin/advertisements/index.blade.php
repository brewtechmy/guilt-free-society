                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-Advertisement">
                    <thead>
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.advertisement.fields.position') }}
                            </th>
                            <th>
                                {{ trans('cruds.advertisement.fields.id') }}
                            </th>
                            <th>
                                {{ trans('cruds.advertisement.fields.name') }}
                            </th>
                            <th>
                                {{ trans('cruds.advertisement.fields.photo') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                            ...
                            <tr data-entry-id="{{ $advertisement->id }}">
                                ...
                                <td>
                                    @if ($advertisement->photo)
                                        <a href="{{ $advertisement->photo->getUrl() }}" target="_blank"
                                            style="display: inline-block">
                                            <img src="{{ $advertisement->photo->getUrl('thumb') }}">
                                        </a>
                                    @endif
                                </td>
                                <td>
                                    @can('advertisement_show')
                                        <a class="btn btn-xs btn-primary"
                                            href="{{ route('admin.advertisements.show', $advertisement->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Advertisement:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
