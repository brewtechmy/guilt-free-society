    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.outlets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_hour') ? 'is-invalid' : '' }}" type="text" name="business_hour" id="business_hour" value="{{ old('business_hour', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('embed_map_url') ? 'is-invalid' : '' }}" name="embed_map_url" id="embed_map_url">{{ old('embed_map_url') }}</textarea>
