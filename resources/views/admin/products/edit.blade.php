        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.products.update', [$product->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-check-input" style="margin-top: 0.4rem; margin-left: 0.5rem;" type="checkbox" name="has_ingredient" id="has_ingredient" value="1" {{ $product->ingredients->count() || old('has_ingredient', 0) === 1 ? 'checked' : '' }}>
                </div>
                <div id="ingredients-group" class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('ingredients') ? 'is-invalid' : '' }}" name="ingredients[]" id="ingredients" multiple style="width: 100%;">
                        @foreach ($ingredients as $id => $ingredient)
                            <option value="{{ $id }}" {{ in_array($id, old('ingredients', [])) || $product->ingredients->contains($id) ? 'selected' : '' }}>{{ $ingredient }}</option>
                        @endforeach
                    </select>
                ...
                <div id="calories-group" class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('calories') ? 'is-invalid' : '' }}" type="number" name="calories" id="calories" value="{{ old('calories', $product->calories) }}" step="1">
