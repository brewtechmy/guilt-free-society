                    ...
                    <div class="flex mt-4 px-8 overflow-x-auto overflow-y-hidden w-full">
                        @foreach ($category->ingredients as $ingredientIndex => $ingredient)
                            <div class="flex flex-col items-center min-w-24 md:min-w-44 lg:min-w-56 xl:min-w-64 mx-8">
                                <img class="rounded-full border-8 border-black aspect-square w-full" src="{{ $ingredient->photo->thumbnail }}" />
                            ...
                            <div class="wheel inline-block align-middle hidden mr-6">
                                <div id="acw-{{ $categoryIndex . '-' . $ingredientIndex }}" class="counter">0</div>
                            </div>
                        @endforeach
                    </div>
                </div>
